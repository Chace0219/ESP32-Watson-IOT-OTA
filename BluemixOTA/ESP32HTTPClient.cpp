 ...
 * This file is part of the ESP32HTTPClient for Arduino.
 *
...
extern const char* OTA_SERVER_ROOT_CA_PEM;
/**
 * constructor
 */
...
bool HTTPClient::begin(String url, String CARoot)
{
	_CAcert = CARoot;
...
bool HTTPClient::begin(String host, uint16_t port, String uri, bool https, String CARoot)
{
	if (https) 
	{
		return begin(host, port, uri, CARoot);
	}
	else 
	{
...
bool HTTPClient::begin(String host, uint16_t port, String uri, String CARoot)
{
    clear();
    _host = host;
    _port = port;
 ...
 * @return WiFiClient
 */
WiFiClientSecure& HTTPClient::getStream(void)
{
    if(connected()) {
        return *_tcp;
    }
 ...
 * @return WiFiClient *
 */
WiFiClientSecure* HTTPClient::getStreamPtr(void)
{
    if(connected()) {
        return _tcp;
    }
...
bool HTTPClient::connect(void)
{
	...
	*/
	...
	_tcp = new WiFiClientSecure();
	//_tcp->setCACert(_CAcert.c_str());
	_tcp->setCACert(OTA_SERVER_ROOT_CA_PEM);

	Serial.println("Conneceting");
